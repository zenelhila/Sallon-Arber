...
<body>
    ...
    <a class="logoPosition" href="index.html"> <img class="logoImg" src="pictures/logo1.png"> </a>
        ...
        <form action='<?php echo $_SERVER['PHP_SELF'] ?>' method='post'>
            ...
            ?>
                ...
                <div>
                    ...
                    <input name='bookingDate' id="date" type="date"
                        <?php if($selectedPreferences) {echo $selectedPreferences?" readonly value='{$clean['bookingDate']}'":"";}?>>
