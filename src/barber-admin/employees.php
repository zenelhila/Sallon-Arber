...
<div class="container-fluid">
    ...
    <?php
                ...
                if($do == 'Manage')
                {
                    ...
                    count(a.user_rating)*5 as countRatings  FROM users u left join appointment a on u.id = a.user_id_barber where u.level=2 
                    GROUP BY u.id;");
                    $stmt->execute();
        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo (isset($_POST['name']))?>"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <?php
                                                if(isset($_POST['add_new_employee']))
                                                {
                                                    if(empty(test_input($_POST['employee_password'])))
                                                    {
                                                        ?>
                            <div class="invalid-feedback" style="display: block;">
            ...
            <?php
                                ...
                                if(isset($_POST['add_new_employee']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_employee_form == 0)
                                {
                                    ...
                                    try
                                    {
                                        $stmt = $con->prepare("insert into users(name,phone,email,level,password) values(?,?,?,?,?) ");
                                        $stmt->execute(array($employee_name,$employee_phone,$employee_email,$employee_level,$employee_password));
        ...
        <div class="card-body">
            ...
            <?php
                                        ...
                                        if(isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_employee_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                $stmt = $con->prepare("update employees set name = ?, phone = ?, email = ? where user_id_barber = ? ");
    ...
    <?php
                        ...
                        {
                            echo "<script>window.location.replace('employees');</script>";
                        }
                    }
                    else
                    {
