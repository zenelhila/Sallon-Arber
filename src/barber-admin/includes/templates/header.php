...
<head>
    ...
    <meta name="author" content="Sallon Arber">
    ...
    <!-- CSS FILES -->
    <link href="Design/css/appointment-page-style.css" rel="stylesheet">
    <link href="Design/css/main.css" rel="stylesheet">
    <link href="Design/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="Design/css/barber-icons.css">
    <link rel="stylesheet" type="text/css" href="Design/css/sb-admin-2.min.css">
    <link rel="stylesheet" type="text/css" href="Design/css/sb-admin-2.css">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Sallon Arber</div>
            </a>
